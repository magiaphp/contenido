...
<?php _t("Editar"); ?></h2> 
 ...
 <?php 
                        $campos = array(array(
"type" => "text",
"name" => "contenido_id_autor",
"value" => "$contenido_id_autor",                                                                        
    
"for" => "contenido_id_autor",
"label" => "id_autor",
"class" => "form-control",
"id" => "contenido_id_autor",
"placeholder" => "id_autor",
                    ),array(
"type" => "text",
"name" => "contenido_tipo",
"value" => "$contenido_tipo",                                                                        
...
"value" => "$contenido_titulo",                                                                        
    
"for" => "contenido_titulo",
"label" => "titulo",
"class" => "form-control",
"id" => "contenido_titulo",
"placeholder" => "titulo",
...
"type" => "text",
"name" => "contenido_contenido",
"value" => "$contenido_contenido",                                                                        
    
"for" => "contenido_contenido",
"label" => "contenido",
"class" => "form-control",
"id" => "contenido_contenido",
...
"type" => "text",
"name" => "contenido_estatus",
"value" => "$contenido_estatus",                                                                        
    
"for" => "contenido_estatus",
"label" => "estatus",
"class" => "form-control",
"id" => "contenido_estatus",
"placeholder" => "estatus",
                    ),);
